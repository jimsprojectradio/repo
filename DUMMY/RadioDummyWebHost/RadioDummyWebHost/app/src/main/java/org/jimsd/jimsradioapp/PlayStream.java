...
public class PlayStream extends Fragment {
    ...
    private void getViewCount(final String code) {
        String url="http://jimsvkattendance.000webhostapp.com/update_views.php?";
    ...
    public void getGuests(final String code){
        String url="http://jimsvkattendance.000webhostapp.com/fetch_prog_only_guest.php?";
        requestQueue= Volley.newRequestQueue(getActivity());
        StringRequest request =new StringRequest(Request.Method.POST,url,
                new Response.Listener<String>() {
                    @Override
    ...
    public void getAnchors(final String code){
        String url="http://jimsvkattendance.000webhostapp.com/fetch_prog_only_anchor.php?";
        requestQueue= Volley.newRequestQueue(getActivity());
        StringRequest request =new StringRequest(Request.Method.POST,url,
                new Response.Listener<String>() {
                    @Override
